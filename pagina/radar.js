			...
			if(boardID == boardId){
				...
				if( topic === pushtopic){	   
					...
					try{
						...
						val = data.measures.jump
						if ('null' != val){
							boardData.radarData.hzre = roundArrTo(getFieldIfExists(val,'hzre'), 2);
...
let radarcalibr = document.getElementById('jmpcalibr');
